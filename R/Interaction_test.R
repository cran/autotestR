...
#'
#' @param y Numeric vector representing the continuous predictor.
#' @param x Numeric vector representing the continuous outcome.
...
#'   ifelse(
#'     group == 'Control',
#'     2 + 1.3 * response + rnorm(n, 0, 2),
#'     2 + 1.2 * response + rnorm(n, 0, 1)
#'   )
#' )
#'
#' test.interaction(
